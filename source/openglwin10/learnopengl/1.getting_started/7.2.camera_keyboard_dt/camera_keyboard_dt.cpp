#include "learnopengl/1.getting_started/7.2.camera_keyboard_dt/camera_keyboard_dt.h"
#include "learnopengl/shader.h"

bool CameraKeyboardDt::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
    bool result;
...
void CameraKeyboardDt::Shutdown()
{
    if (m_OpenGL)
    {
...
void CameraKeyboardDt::SetMsg(const MSG& msg)
{
    m_msg = msg;
}

void CameraKeyboardDt::processInput()
{
