#include "learnopengl/1.getting_started/6.3.coordinate_systems_multiple/coordinate_systems_multiple.h"
#include "learnopengl/shader.h"

bool CoordinateSystemsMultiple::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	bool result;
	...
	// ------------------------------------
	ourShader = new Shader("6.3.coordinate_systems.vs", "6.3.coordinate_systems.fs", m_OpenGL);
...
void CoordinateSystemsMultiple::Shutdown()
{
    if (m_OpenGL)
    {
...
bool CoordinateSystemsMultiple::Frame()
{
