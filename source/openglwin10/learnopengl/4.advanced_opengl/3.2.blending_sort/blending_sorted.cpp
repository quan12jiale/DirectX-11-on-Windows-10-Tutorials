#include "learnopengl/4.advanced_opengl/3.2.blending_sort/blending_sorted.h"
...
void BlendingSorted::initializeGL()
{
	this->resize(800, 600);
    ...
    // -------------------------
    ourShader = new Shader("3.2.blending.vs", "3.2.blending.fs", this);
    ...
    transparentTexture = Util::loadTexture("resources/textures/window.png", this);
...
void BlendingSorted::resizeGL(int w, int h)
{
    this->glViewport(0, 0, w, h);
    this->update();
}

void BlendingSorted::paintGL()
{
    ...
    {
        float distance = camera.Position.distanceToPoint(windows[i]);
...
void BlendingSorted::keyPressEvent(QKeyEvent* ev)
{
    switch (ev->key()) {
    case Qt::Key_W:
...
void BlendingSorted::mouseMoveEvent(QMouseEvent* ev)
{
...
void BlendingSorted::wheelEvent(QWheelEvent* ev)
{
