...
}UBO2;// rename to fix: Failed to link shader program: Uniform "UBO" has different type across different shaders.
...
void main() {
    ...
    vec4 color = UBO2.ambientLight;
    
    // Invert the light direction for calculations.
    vec3 lightDir = -UBO2.lightDirection;
    ...
    if(lightIntensity > 0.0f)
    {
        ...
        color += (UBO2.diffuseLightColor * lightIntensity);
    }
